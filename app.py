...
image_path = "C:\\Users\\LENOVO\\Downloads\\2471303.gif"
...
[data-testid="stAppViewContainer"] {{
    ...
    background-size:  100% 100%  ;  /* Adjust the background size */
...
def login():
    ...
    if st.button("Login"):
        if username in USER_CREDENTIALS and USER_CREDENTIALS[username] == password:
            ...
            st.experimental_rerun()  # Redirect to main application
        else:
...
def home_page():
    ...
    st.title("Welcome to the Advanced AI-Driven Urban Planning Tool")

    # Introduction
    st.markdown("""
    This tool leverages advanced AI techniques to assist urban planners and stakeholders in making informed decisions about urban development.
    
    You can analyze data, visualize trends, generate proposals, and gain insights into sustainable urban planning.
    
    Explore the features below to get started!
    """)

    # Quick Links
    st.subheader("Quick Links to Features")
    col1, col2, col3 = st.columns(3)

    with col1:
        if st.button("Data Submission"):
            st.session_state.page = "Submission"  # Set page for navigation
            st.experimental_rerun()  # Rerun to navigate

    with col2:
        if st.button("Visualize Data"):
            st.session_state.page = "Visualize Data"
            st.experimental_rerun()

    with col3:
        if st.button("Urban Proposals"):
            st.session_state.page = "Urban Proposals"
            st.experimental_rerun()

    # Recent Activities
    st.subheader("Recent Activities")
    st.markdown("""
    - **Data Generation**: Generate synthetic urban data to simulate various scenarios.
    - **Sustainability Insights**: Calculate sustainability scores based on uploaded data.
    - **Predictive Analytics**: Use AI to predict future urban trends.
    """)

    # Closing Message
    st.markdown("""
    Get started by selecting a feature from the sidebar or the quick links above.
    """)

# Add this function call in your main function's page selection
# elif choice == "Home":
#     home_page()  # Call the home_page function for the main content
...
def main():
    ...
    # Start a Bootstrap container
    st.markdown('<div class="container">', unsafe_allow_html=True)
    st.title("Advanced AI-Driven Urban Planning Tool")

    # Sidebar menu
    menu = ["Home", "Submission", "Feedback", "Visualize Data", "Analyze Data", "Urban Proposals", "Insights"]
    ...
    if choice == "Home":
        ...
        submission_page()  # Call the submission_page function for submission content
    elif choice == "Visualize Data":
        visualize_data_page()  # Call the visualize_data_page function
    elif choice == "Analyze Data":
        analyze_data_page()  # Call the analyze_data_page function
    elif choice == "Urban Proposals":
        urban_proposals_page()  # Call the urban_proposals_page function
    elif choice == "Insights":
        insights_page()  # Call the insights_page function
    elif choice == "Feedback":
        feedback_page()  # Call feedback_page for feedback content

    st.markdown('<div class="footer">Powered by AI</div>', unsafe_allow_html=True)

def submission_page():
    # Implement the submission page logic here
...
def visualize_data_page():
    df = submission_page()  # Call submission to load data
    if df is not None:
...
def urban_proposals_page():
    df = submission_page()  # Call submission to load data
    if df is not None:
        st.subheader("Urban Development Proposals")
        focus_areas = [
            "Traffic optimization", "Green space expansion", "Population density management",
            "Sustainable urban development", "Public transportation improvement", "Crime reduction",
            "Economic development", "Air quality improvement", "Healthcare and education enhancement",
            "Smart city initiatives", "Water and waste management", "Elderly care and accessibility"
        ]
